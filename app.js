...
function colorizerSliders(color, hue, brightness, saturation) {
    // Scale saturation
...
function hslControls(e) {
    const index = e.target.getAttribute('data-bright') || e.target.getAttribute('data-saturation') || e.target.getAttribute('data-hue');
